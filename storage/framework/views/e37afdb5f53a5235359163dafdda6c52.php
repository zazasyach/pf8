...
<body>
    ...
    <div class="container-sm mt-5">
        <form action="<?php echo e(route('employees.update', $employee->employee_id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="firstName" id="firstName" value="<?php echo e($employee->firstname); ?>">
...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="lastName" id="lastName" value="<?php echo e($employee->lastname); ?>">
...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="email" id="email" value="<?php echo e($employee->email); ?>">
...
unset($__errorArgs, $__bag); ?>" type="text" name="age"
                                id="age" value="<?php echo e($employee->age); ?>">
                            <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH C:\xampp\htdocs\tugas5_1laravellll\laravel\resources\views/employee/edit.blade.php ENDPATH**/ ?>